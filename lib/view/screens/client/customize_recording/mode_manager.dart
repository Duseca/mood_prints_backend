  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        ...
        body: (UserService.instance.userModel.value.authorizeMoodPrintsAccess ==
                true)
            ? Column(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              CommonImageView(
                                  imagePath: Assets.imagesColorPallet),
                                        ...
                                        InkWell(
                                          ...
                                          child: Icon(
                                            ((modeCtrl.selectedMood.value ==
                                                ...
                                                : Icons.circle,
                                            color:
                                                modeIndicatorItems[index].color,
                                          ),
                                        ),
                                        MyText(
                                          text:
                                              '${modeIndicatorItems[index].text}',
                                          size: 12,
                                          weight: FontWeight.w600,
                              ...
                              Obx(
                                () => Container(
                                  ...
                                  child: Center(
                                    child: MyText(
                                      text:
                                          "${modeCtrl.selectedMood.value.mode}",
                                      size: 14,
                                      weight: FontWeight.w600,
                                      color: (modeCtrl.selectedMood.value
                                                      .stressLevel >=
                                                  0 &&
                                              modeCtrl.selectedMood.value
                                                      .stressLevel <=
                        ...
                        (modeCtrl.activeWidgets.isNotEmpty)
                            ? Column(
                                children: List.generate(
                                    modeCtrl.activeWidgets.length, (headIndex) {
                                                                ...
                                                                () => Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      ...
                                                                      color:
                                                                          kLightGreyColor,
                                                                      border: Border.all(
                                                                          color: (ctrl.selectedEmojiTextModel.value == ctrl.activeWidgets[headIndex].data[index])
                                                                              ? kSecondaryColor
                                                                              : Colors
                                                                                  .transparent,
                                                                          width:
                            ...
                            children: [
                              ...
                              Obx(
                                () => (modeCtrl.todayPhotos.isNotEmpty)
                                    ...
                                    : CommonImageView(
                                        imagePath:
                                            Assets.imagesImagePlaceHolder2,
                                        height: 300,
                                        radius: 12,
                                        fit: BoxFit.cover,
                                      ),
            ...
            : Center(
                child: Column(
                  ...
                  children: [
                    ...
                    MyText(
                      paddingTop: 10,
                      text: "MoodPrints Access Disabled",
                      size: 18,
                    ...
                    MyText(
                      ...
                      paddingTop: 5,
                      text:
                          """Disabling MoodPrints access will limit your account and schedule it for deletion in 10 days.
To continue using mood tracking, chat, and emotional insights, please re-enable MoodPrints access in Settings > HIPAA Compliance.""",
                      size: 14,
                    ),
                  ],
                ),
